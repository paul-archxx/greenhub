  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center lg:p-4">
        <div className="bg-white lg:rounded-3xl shadow-2xl w-full lg:max-w-md max-lg:h-[100dvh] max-lg:w-screen lg:max-h-[90vh] overflow-hidden">
          {/* Header */}
              ...
              <div className="">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-gray-300 text-black rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300"
                    disabled={isUploading}
                    required
                  />
                  <button
                  ...
                  >
                    {showPassword ? (
                      ...
                      <div className="w-5 text-black/60">
                        <svg
